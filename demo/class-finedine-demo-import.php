...
if ( ! class_exists( 'Finedine_Demo_Import' ) ) {
	/**
	 * Main class
	 *
	 * @since 1.0.0
	 */
	class Finedine_Demo_Import {
		/**
		 * Singleton instance of Finedine_Demo_Import.
		 *
		 * @var Finedine_Demo_Import $instance Finedine_Demo_Import instance.
		 */
		...
		/**
		 * Main Finedine_Demo_Import instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Finedine_Demo_Import ) ) {
				self::$instance = new Finedine_Demo_Import();
